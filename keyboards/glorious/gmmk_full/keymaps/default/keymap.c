...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
		...
		KC_CAPS,    KC_A,   RESET/*KC_S*/,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT, KC_BSLS, KC_KP_4, KC_KP_5, KC_KP_6, 
		KC_LSFT,    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_LSFT, KC_ENT, KC_KP_1, KC_KP_2, KC_KP_3, 
		KC_LCTL,    KC_LGUI,KC_LALT,KC_SPC, KC_RALT,MO(_FN1),KC_APP,KC_RCTL,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT, KC_BSPC, KC_KP_0, KC_KP_DOT, KC_KP_ENTER,
